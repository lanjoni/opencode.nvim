...
local open_diff_tool = require("opencode.tools.open_diff")
...
describe("openDiff tool MCP compliance", function()
  ...
  after_each(function()
    ...
    require("opencode.diff")._cleanup_all_active_diffs("test_cleanup")
  end)
  ...
  describe("MCP-compliant responses", function()
    it("should return MCP format on file save", function()
      ...
      vim.schedule(function()
        require("opencode.diff")._resolve_diff_as_saved(test_tab_name, 1)
      end)
    ...
    it("should return MCP format on diff rejection", function()
      ...
      vim.schedule(function()
        require("opencode.diff")._resolve_diff_as_rejected(test_tab_name)
      end)
