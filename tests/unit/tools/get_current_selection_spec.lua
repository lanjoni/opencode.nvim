...
describe("Tool: get_current_selection", function()
  ...
  before_each(function()
    ...
    package.loaded["opencode.tools.get_current_selection"] = nil
    get_current_selection_handler = require("opencode.tools.get_current_selection").handler
  ...
  it("should return the selection data from opencode.selection if available", function()
    local mock_sel_data = {
      text = "selected text",
  ...
  it("should handle pcall failure when requiring selection module", function()
    ...
    package.loaded["opencode.selection"] = nil -- Ensure it's not cached
